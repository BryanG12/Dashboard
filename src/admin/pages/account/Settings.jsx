  ...
  return (
    <>
      <div className="bg-secondary-100 p-8 rounded-xl mb-8">
        <h2 className="text-xl text-gray-100" >Perfil</h2>
        ...
        <form autoComplete='off'>
          <div className="flex items-center mb-8 ">
            ...
            <div className="flex-1 md:flex-row flex-col">
              <div className="relative mb-2">
                ...
                >
                  <RiEdit2Line className=' hover:text-cyan-600' />
                </label>
          ...
          <div className="flex flex-col gap-y-2 md:flex-row md:items-center mb-8">
            ...
            <div className="flex-1 flex items-center gap-4 md:flex-row flex-col">
              <div className='w-full'>
                <input
                  type="text"
                  className="w-full py-2 px-4 outline-none rounded-lg bg-secondary-900  focus:outline-cyan-900"
          ...
          <div className="flex flex-col gap-y-2 md:flex-row md:items-center mb-8">
            ...
            <div className="flex-1 flex items-center gap-4 md:flex-row flex-col">
              <div className='w-full'>
                <select className="w-full py-2 px-4 outline-none rounded-lg bg-secondary-900   focus:outline-cyan-900 appearance-none" >
        ...
        <div className="flex justify-end">
          <button
            className="bg-primary/80 text-black py-2 px-4 rounded-lg hover:bg-primary hover:text-white transition-colors"
            id='guardar-perfil'
          >
            Guardar
          </button>
        ...
        <form className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center gap-y-4 justify-between">
            <div>
              ...
              <p className="text-gray-500 text-sm">spike@gmail.com</p>
            </div>
            <div>
              <button className="w-full md:w-auto bg-secondary-900/50 py-3 px-4 rounded-lg hover:bg-secondary-900 hover:text-cyan-500 transition-colors">
                Cambiar email
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-y-4 justify-between">
            ...
            <div>
              <button className="w-full md:auto bg-secondary-900/50 py-3 px-4 rounded-lg hover:bg-secondary-900 hover:text-cyan-500 transition-colors">
                Cambiar contraseña
              </button>
            </div>
          </div>
      ...
      {/* conectarse a cuentas */}
      <div className="bg-secondary-100 p-8 rounded-xl mb-8">
        <h1 className="text-xl text-gray-100">Conectarse a cuentas</h1>
        <hr className="my-8 border-gray-500/30" />
